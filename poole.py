...
menu-position: 4
---
Tough Poole is for simple websites, it has simple support for
content generation using Python code inlined in page files. This is everything
but a clear separation of logic and content but for rather simple sites this is
just a pragmatic way to get things done. For instance the menu on this page
is generated by some inlined Python code in the project's `page.html` file.

You can simply stop reading here if you are happy with what Poole does right
now. Otherwise head over to the project site for some documentation about
content generation in Poole. 
""",
